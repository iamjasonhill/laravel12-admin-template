<header class="bg-white dark:bg-gray-800 shadow">
    <div class="flex justify-between items-center py-4 px-6">
        <div class="flex items-center">
            ...
            <h1 class="text-xl font-semibold ml-2">{{ $title ?? 'Dashboard' }}</h1>
        </div>
        
        <div class="flex items-center">
            <!-- Theme Toggle -->
            <button id="theme-toggle" class="p-2 mr-4 text-gray-500 hover:text-gray-700 dark:text-gray-300 dark:hover:text-gray-100 focus:outline-none rounded-md transition-colors duration-200 ease-in-out hover:bg-gray-100 dark:hover:bg-gray-700">
            ...
            <!-- Notifications -->
            <button class="p-2 mr-4 text-gray-500 hover:text-gray-700 dark:hover:text-gray-300 focus:outline-none">
                <svg class="h-6 w-6" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <div class="relative" x-data="{ open: false }">
                <button @click="open = !open" class="flex items-center focus:outline-none">
                    <div class="w-8 h-8 overflow-hidden rounded-full bg-gray-200 dark:bg-gray-600">
                        <svg class="h-full w-full text-gray-500" fill="currentColor" viewBox="0 0 24 24">
                            <path d="M24 20.993V24H0v-2.996A14.977 14.977 0 0112.004 15c4.904 0 9.26 2.354 11.996 5.993zM16.002 8.999a4 4 0 11-8 0 4 4 0 018 0z" />
                        </svg>
                    </div>
                    <span class="ml-2 text-gray-700 dark:text-gray-300">{{ Auth::user()->name ?? 'Admin User' }}</span>
                    <svg class="ml-2 h-4 w-4 text-gray-500" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
